...
class CartAdapter(val posts: ArrayList<Book>, var dealClickHandler: ClickHandler) : RecyclerView.Adapter<CartAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val undoButton: Button = itemView.findViewById(R.id.dealButton)

        init {
            undoButton.setOnClickListener { view -> dealClickHandler!!.onClick(posts.get(adapterPosition)) }
        }
